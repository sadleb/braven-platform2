class CourseCustomContentVersion < ApplicationRecord
  ...
  def self.publish!(course, custom_content, user, rubric_id=nil)
    ...
    begin
      transaction do
        ...
        CanvasAPI.client.update_assignment_lti_launch_url(
          ...
          course_custom_content_version.new_submission_url,
        )
      ...
      CanvasAPI.client.delete_assignment(course.canvas_course_id, canvas_assignment['id']) if canvas_assignment
      raise
    end
  end
