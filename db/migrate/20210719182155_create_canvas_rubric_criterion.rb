class CreateCanvasRubricCriterion < ActiveRecord::Migration[6.1]
  def change
    ...
    # easier.
    create_table :canvas_rubric_criterion do |t|
      ...
      t.index [:canvas_rubric_id, :canvas_criterion_id],
        unique: true,
        name: 'index_canvas_criterion_unique_1'
    end
  end
end
