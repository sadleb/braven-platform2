...
Devise.setup do |config|
  ...
  config.warden do |manager|
    # For requests made in the context of an authenticated LtiLaunch, use this
    # authentication strategy to validate that the request is authenticated
    # based on the LTI Launch handshake. Note that this only applies if the browser
    # doesn't accept third party cookies. If it does, the lti_launch_controller will
