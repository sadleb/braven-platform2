...
#      allow(ComputeRise360ModuleGrade).to receive(:compute_grade).and_return(raw_grade)
#    end
#
#    subject(:run_job) do
#      GradeRise360ModuleForUserJob.perform_now(user, lti_launch, canvas_course_id, canvas_assignment_id)
#    end
#
#    it 'calls ComputeRise360ModuleGrade with the correct params' do
#      run_job
#      expect(ComputeRise360ModuleGrade).to have_received(:compute_grade)
