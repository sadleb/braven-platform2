...
#  config.ignore_hosts 'platformweb', 'stagingplatform.bebraven.org', 'platform.bebraven.org', 'chromedriver.storage.googleapis.com', 'api.codacy.com', 'platform-dev-file-uploads.s3.amazonaws.com'
