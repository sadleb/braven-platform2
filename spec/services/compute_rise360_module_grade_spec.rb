...
#
#        grade = ComputeRise360ModuleGrade.compute_grade(user.id, canvas_assignment_id, activity_id)
...
#        allow(ComputeRise360ModuleGrade)
...
#        grade = ComputeRise360ModuleGrade.compute_grade(user.id, canvas_assignment_id, assignment_overrides)
#
...
#        expect(interactions).to be_empty
#
#        grade = ComputeRise360ModuleGrade.grade_module_engagement(interactions)
...
#        grade = ComputeRise360ModuleGrade.grade_mastery_quiz(interactions, quiz_questions)
#        expect(grade).to eq(0)
#
#        Rise360ModuleInteraction.create!(
#          verb: Rise360ModuleInteraction::ANSWERED,
...
#          .where(verb: Rise360ModuleInteraction::ANSWERED)
#
#        grade = ComputeRise360ModuleGrade.grade_mastery_quiz(interactions, 2)
#        expect(grade).to eq(0)
#      end
#    end
...
#    subject { ComputeRise360ModuleGrade.due_date_for_user(user.id, assignment_overrides) }
...
#    subject { ComputeRise360ModuleGrade.grade_completed_on_time(interactions, due_date) }
#
