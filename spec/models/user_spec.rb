...
RSpec.describe User, type: :model do
  ...
  describe '#remove_section_roles' do
    ...
    # Once we create a Section with a canvas_section_id, since it's in Canvas
    # and could be re-used at anytime even if it's "deleted" b/c of the unique
    # sis_id, always keep the Sections around to avoid errors if we start using it
    # again.
